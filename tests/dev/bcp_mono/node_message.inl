...
enum node_message 
{
	...
	node_message_commit_block_req_id,
	node_message_commit_block_ack_id,
...
class node_message_commit_block_req : public message
{
	using block_header = bryllite::block_header;
public:
	block_header _block_header;
...
public:
	node_message_commit_block_req( block_header header ) : _ctor( node_message_commit_block_req ), _block_header( header ) {
	};
};

class node_message_commit_block_ack : public message
{
	enum { max_block_size = 16 * 1024 };
	using block = bryllite::block;
public:
...
public:
	node_message_commit_block_ack( block b ) : _ctor( node_message_commit_block_ack ) {
		b.serialize( _block, sizeof( _block ) );
	};
