...
// Explicit instantiations for base_blob<264>
template base_blob<264>::base_blob( const std::vector<unsigned char>& );
template std::string base_blob<264>::GetHex() const;
template std::string base_blob<264>::ToString() const;
template void base_blob<264>::SetHex( const char* );
template void base_blob<264>::SetHex( const std::string& );
